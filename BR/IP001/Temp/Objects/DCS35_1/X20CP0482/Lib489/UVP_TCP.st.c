...
#include "C:/Users/User/Desktop/IP001/IP001/Temp/Objects/DCS35_1/X20CP0482/Lib489/UVP_TCPst.h"
#line 1 "C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/Lib489/UVP_TCP.nodebug"
#line 2 "C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/Lib489/UVP_TCP.st"
void UVP_TCP(struct UVP_TCP* inst){struct UVP_TCP* __inst__=inst;{
switch(__inst__->step){
case 0:{
(__inst__->req_3x.enable=1);;(__inst__->req_3x.pStation=__inst__->pPort);;(__inst__->req_3x.startAddress=1800);;(__inst__->req_3x.nrRegisters=7);;(__inst__->req_3x.pData=((unsigned long)(&__inst__->UVP_Data.Time)));;(__inst__->req_3x.dataSize=14);;mbReadHoldingRegisters(&__inst__->req_3x);
...
(__inst__->req_3x.enable=1);;(__inst__->req_3x.pStation=__inst__->pPort);;(__inst__->req_3x.startAddress=100);;(__inst__->req_3x.nrRegisters=1);;(__inst__->req_3x.pData=((unsigned long)(&__inst__->UVP_Data.Byte_order)));;(__inst__->req_3x.dataSize=2);;mbReadHoldingRegisters(&__inst__->req_3x);
if((((unsigned long)(unsigned short)__inst__->req_3x.status!=(unsigned long)(unsigned short)65535))){
(__inst__->step=2);
}
(__inst__->state=__inst__->req_3x.status);
...
(__inst__->req_6x.enable=1);;(__inst__->req_6x.pStation=__inst__->pPort);;(__inst__->req_6x.startAddress=100);;(__inst__->req_6x.value=__inst__->UVP_Data.Byte_order_new);;mbWriteSingleRegister(&__inst__->req_6x);
...
(__inst__->req_4x.enable=1);;(__inst__->req_4x.pStation=__inst__->pPort);;(__inst__->req_4x.startAddress=(2000+(__inst__->curTP*100)));;(__inst__->req_4x.nrRegisters=46);;(__inst__->req_4x.pData=((unsigned long)(&__inst__->UVP_Data.LineCurrent[(__inst__->curTP+1)-1])));;(__inst__->req_4x.dataSize=92);;mbReadInputRegisters(&__inst__->req_4x);
...
(__inst__->req_4x.enable=1);;(__inst__->req_4x.pStation=__inst__->pPort);;(__inst__->req_4x.startAddress=((2000+(__inst__->curTP*100))+60));;(__inst__->req_4x.nrRegisters=10);;(__inst__->req_4x.pData=((unsigned long)(&__inst__->UVP_Data.Prev_hour[(__inst__->curTP+1)-1])));;(__inst__->req_4x.dataSize=20);;mbReadInputRegisters(&__inst__->req_4x);
if((((unsigned long)(unsigned short)__inst__->req_4x.status!=(unsigned long)(unsigned short)65535))){
(__inst__->step=5);
}
(__inst__->state=__inst__->req_4x.status);
...
(__inst__->req_4x.enable=1);;(__inst__->req_4x.pStation=__inst__->pPort);;(__inst__->req_4x.startAddress=((2000+(__inst__->curTP*100))+80));;(__inst__->req_4x.nrRegisters=10);;(__inst__->req_4x.pData=((unsigned long)(&__inst__->UVP_Data.Prev_day[(__inst__->curTP+1)-1])));;(__inst__->req_4x.dataSize=20);;mbReadInputRegisters(&__inst__->req_4x);
if((((unsigned long)(unsigned short)__inst__->req_4x.status!=(unsigned long)(unsigned short)65535))){
(__inst__->curTP=(__inst__->curTP+1));
(__inst__->step=6);
}
...
(__inst__->req_16x.enable=1);;(__inst__->req_16x.pStation=__inst__->pPort);;(__inst__->req_16x.startAddress=1005);;(__inst__->req_16x.nrRegisters=5);;(__inst__->req_16x.pData=((unsigned long)(&__inst__->UVP_Data.NTP)));;(__inst__->req_16x.dataSize=10);;mbWriteMultipleRegisters(&__inst__->req_16x);
...
(__inst__->req_3x.enable=1);;(__inst__->req_3x.pStation=__inst__->pPort);;(__inst__->req_3x.startAddress=1005);;(__inst__->req_3x.nrRegisters=3);;(__inst__->req_3x.pData=((unsigned long)(&__inst__->UVP_Data.NTP)));;(__inst__->req_3x.dataSize=6);;mbReadHoldingRegisters(&__inst__->req_3x);
if((((unsigned long)(unsigned short)__inst__->req_3x.status!=(unsigned long)(unsigned short)65535))){
(__inst__->step=8);
}
(__inst__->state=__inst__->req_3x.status);
}break;case 8:{
(__inst__->req_3x.enable=1);;(__inst__->req_3x.pStation=__inst__->pPort);;(__inst__->req_3x.startAddress=1008);;(__inst__->req_3x.nrRegisters=1);;(__inst__->req_3x.pData=((unsigned long)(&__inst__->UVP_Data.DeltaTime)));;(__inst__->req_3x.dataSize=2);;mbReadHoldingRegisters(&__inst__->req_3x);
if((((unsigned long)(unsigned short)__inst__->req_3x.status!=(unsigned long)(unsigned short)65535))){
(__inst__->step=9);
}
(__inst__->state=__inst__->req_3x.status);
...
(__inst__->req_3x.enable=1);;(__inst__->req_3x.pStation=__inst__->pPort);;(__inst__->req_3x.startAddress=1100);;(__inst__->req_3x.nrRegisters=32);;(__inst__->req_3x.pData=((unsigned long)(&__inst__->UVP_Data.MR_113)));;(__inst__->req_3x.dataSize=64);;mbReadHoldingRegisters(&__inst__->req_3x);
if((((unsigned long)(unsigned short)__inst__->req_3x.status!=(unsigned long)(unsigned short)65535))){
...
(__inst__->req_16x.enable=1);;(__inst__->req_16x.pStation=__inst__->pPort);;(__inst__->req_16x.startAddress=1100);;(__inst__->req_16x.nrRegisters=32);;(__inst__->req_16x.pData=((unsigned long)(&__inst__->UVP_Data.MR_113_new)));;(__inst__->req_16x.dataSize=64);;mbWriteMultipleRegisters(&__inst__->req_16x);
if((((unsigned long)(unsigned short)__inst__->req_16x.status!=(unsigned long)(unsigned short)65535))){
...
#line 117 "C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/Lib489/UVP_TCP.nodebug"

void __AS__ImplInitUVP_TCP_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/User/Desktop/IP001/IP001/Temp/Objects/DCS35_1/X20CP0482/Lib489/UVP_TCP.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/User/Desktop/IP001/IP001/Temp/Objects/DCS35_1/X20CP0482/Lib489/UVP_TCP.st.c\\\" \\\"C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/Lib489/UVP_TCP.st\\\"\\n\"");
