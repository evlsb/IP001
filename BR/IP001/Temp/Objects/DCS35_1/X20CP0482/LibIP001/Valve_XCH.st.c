...
#include "C:/Users/User/Desktop/IP001/IP001/Temp/Objects/DCS35_1/X20CP0482/LibIP001/Valve_XCHst.h"
#line 1 "C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/LibIP001/Valve_XCH.nodebug"
#line 2 "C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/LibIP001/Valve_XCH.st"
...
case 0:{(__inst__->MBMCmd_0.ident=__inst__->MBMOpen_0.ident);;(__inst__->MBMCmd_0.mfc=4);;(__inst__->MBMCmd_0.node=1);;(__inst__->MBMCmd_0.data=((unsigned long)(&__inst__->MB.Status)));;(__inst__->MBMCmd_0.offset=3);;(__inst__->MBMCmd_0.len=1);;MBMCmd(&__inst__->MBMCmd_0);
if((((unsigned long)(unsigned short)__inst__->MBMCmd_0.status==(unsigned long)(unsigned short)0))){
(__inst__->step=1);
}
}break;case 1:{(__inst__->MBMCmd_0.ident=__inst__->MBMOpen_0.ident);;(__inst__->MBMCmd_0.mfc=4);;(__inst__->MBMCmd_0.node=1);;(__inst__->MBMCmd_0.data=((unsigned long)(&__inst__->MB.Cur_Position)));;(__inst__->MBMCmd_0.offset=2);;(__inst__->MBMCmd_0.len=1);;MBMCmd(&__inst__->MBMCmd_0);
if((((unsigned long)(unsigned short)__inst__->MBMCmd_0.status==(unsigned long)(unsigned short)0))){
(__inst__->step=2);
}
}break;case 2:{if((((unsigned long)(unsigned short)__inst__->MB.Commands!=(unsigned long)(unsigned short)__inst__->r0))){
(__inst__->MBMCmd_0.ident=__inst__->MBMOpen_0.ident);;(__inst__->MBMCmd_0.mfc=6);;(__inst__->MBMCmd_0.node=1);;(__inst__->MBMCmd_0.data=((unsigned long)(&__inst__->cmd_buf)));;(__inst__->MBMCmd_0.offset=1);;(__inst__->MBMCmd_0.len=1);;MBMCmd(&__inst__->MBMCmd_0);
if((((unsigned long)(unsigned short)__inst__->MBMCmd_0.status==(unsigned long)(unsigned short)0))){
...
(__inst__->MBMCmd_0.ident=__inst__->MBMOpen_0.ident);;(__inst__->MBMCmd_0.mfc=6);;(__inst__->MBMCmd_0.node=1);;(__inst__->MBMCmd_0.data=((unsigned long)(&__inst__->Set_Position)));;(__inst__->MBMCmd_0.offset=2);;(__inst__->MBMCmd_0.len=1);;MBMCmd(&__inst__->MBMCmd_0);
if((((unsigned long)(unsigned short)__inst__->MBMCmd_0.status==(unsigned long)(unsigned short)0))){
...
#line 80 "C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/LibIP001/Valve_XCH.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/User/Desktop/IP001/IP001/Temp/Objects/DCS35_1/X20CP0482/LibIP001/Valve_XCH.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/User/Desktop/IP001/IP001/Temp/Objects/DCS35_1/X20CP0482/LibIP001/Valve_XCH.st.c\\\" \\\"C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/LibIP001/Valve_XCH.st\\\"\\n\"");
