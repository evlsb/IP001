...
#include "C:/Users/User/Desktop/IP001/Temp/Objects/DCS2_2/X20CP0482/LibIP001/Valve_Biffist.h"
#line 1 "C:/Users/User/Desktop/IP001/Logical/Libraries/LibIP001/Valve_Biffi.nodebug"
#line 9 "C:/Users/User/Desktop/IP001/Logical/Libraries/LibIP001/Valve_Biffi.st"
void Valve_Biffi(struct Valve_Biffi* inst){struct Valve_Biffi* __inst__=inst;{

if(((_2byte_bit_field_*)(&__inst__->r0))->bit0){
if(((_2byte_bit_field_*)(&__inst__->r1))->bit7){
...
if(((_2byte_bit_field_*)(&__inst__->r1))->bit6){
(((_2byte_bit_field_*)(&__inst__->r0))->bit1=0);
}else{
(((_2byte_bit_field_*)(&__inst__->r0))->bit0=0);
(((_2byte_bit_field_*)(&__inst__->r0))->bit2=0);
...
if((((_2byte_bit_field_*)(&__inst__->MB.Status))->bit2^1)){
(((_2byte_bit_field_*)(&__inst__->r0))->bit2=0);
}else{
(((_2byte_bit_field_*)(&__inst__->r0))->bit0=0);
(((_2byte_bit_field_*)(&__inst__->r0))->bit1=0);
...
case 0:{(__inst__->MBMCmd_0.enable=1);;(__inst__->MBMCmd_0.ident=__inst__->MBMOpen_0.ident);;(__inst__->MBMCmd_0.mfc=3);;(__inst__->MBMCmd_0.node=1);;(__inst__->MBMCmd_0.data=((unsigned long)(&__inst__->MB.Status)));;(__inst__->MBMCmd_0.offset=3001);;(__inst__->MBMCmd_0.len=1);;MBMCmd(&__inst__->MBMCmd_0);
if((((unsigned long)(unsigned short)__inst__->MBMCmd_0.status==(unsigned long)(unsigned short)0))){
(__inst__->step=1);
}
}break;case 1:{(__inst__->MBMCmd_0.enable=1);;(__inst__->MBMCmd_0.ident=__inst__->MBMOpen_0.ident);;(__inst__->MBMCmd_0.mfc=3);;(__inst__->MBMCmd_0.node=1);;(__inst__->MBMCmd_0.data=((unsigned long)(&__inst__->MB.Cur_Position)));;(__inst__->MBMCmd_0.offset=3004);;(__inst__->MBMCmd_0.len=1);;MBMCmd(&__inst__->MBMCmd_0);
if((((unsigned long)(unsigned short)__inst__->MBMCmd_0.status==(unsigned long)(unsigned short)0))){
(__inst__->Get_Position=__inst__->MB.Cur_Position);
(__inst__->step=2);
}
}break;case 2:{if((((unsigned long)(unsigned short)__inst__->MB.Commands!=(unsigned long)(unsigned short)__inst__->r0))){
(__inst__->MBMCmd_0.enable=1);;(__inst__->MBMCmd_0.ident=__inst__->MBMOpen_0.ident);;(__inst__->MBMCmd_0.mfc=6);;(__inst__->MBMCmd_0.node=1);;(__inst__->MBMCmd_0.data=((unsigned long)(&__inst__->r0)));;(__inst__->MBMCmd_0.offset=3006);;(__inst__->MBMCmd_0.len=1);;MBMCmd(&__inst__->MBMCmd_0);
if((((unsigned long)(unsigned short)__inst__->MBMCmd_0.status==(unsigned long)(unsigned short)0))){
(__inst__->MB.Commands=__inst__->r0);
(__inst__->step=3);
}
}else{
(__inst__->step=3);
...
(__inst__->MBMCmd_0.enable=1);;(__inst__->MBMCmd_0.ident=__inst__->MBMOpen_0.ident);;(__inst__->MBMCmd_0.mfc=6);;(__inst__->MBMCmd_0.node=1);;(__inst__->MBMCmd_0.data=((unsigned long)(&__inst__->Set_Position)));;(__inst__->MBMCmd_0.offset=3007);;(__inst__->MBMCmd_0.len=1);;MBMCmd(&__inst__->MBMCmd_0);
if((((unsigned long)(unsigned short)__inst__->MBMCmd_0.status==(unsigned long)(unsigned short)0))){
...
(((_2byte_bit_field_*)(&__inst__->r1))->bit2=((_2byte_bit_field_*)(&__inst__->MB.Status))->bit5);
(((_2byte_bit_field_*)(&__inst__->r1))->bit3=((_2byte_bit_field_*)(&__inst__->MB.Status))->bit4);
(((_2byte_bit_field_*)(&__inst__->r1))->bit4=(((_2byte_bit_field_*)(&__inst__->MB.Status))->bit2&((_2byte_bit_field_*)(&__inst__->r0))->bit0));
(((_2byte_bit_field_*)(&__inst__->r1))->bit5=(((_2byte_bit_field_*)(&__inst__->MB.Status))->bit2&((_2byte_bit_field_*)(&__inst__->r0))->bit1));
(((_2byte_bit_field_*)(&__inst__->r1))->bit6=((_2byte_bit_field_*)(&__inst__->MB.Status))->bit1);
(((_2byte_bit_field_*)(&__inst__->r1))->bit7=((_2byte_bit_field_*)(&__inst__->MB.Status))->bit0);
...
}imp1_else15_1:imp1_end15_0:;}
#line 91 "C:/Users/User/Desktop/IP001/Logical/Libraries/LibIP001/Valve_Biffi.nodebug"

void __AS__ImplInitValve_Biffi_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/User/Desktop/IP001/Temp/Objects/DCS2_2/X20CP0482/LibIP001/Valve_Biffi.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/User/Desktop/IP001/Temp/Objects/DCS2_2/X20CP0482/LibIP001/Valve_Biffi.st.c\\\" \\\"C:/Users/User/Desktop/IP001/Logical/Libraries/LibIP001/Valve_Biffi.st\\\"\\n\"");
