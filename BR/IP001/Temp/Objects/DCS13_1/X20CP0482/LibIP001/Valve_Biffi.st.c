...
#include "C:/Users/User/Desktop/IP001/IP001/Temp/Objects/DCS13_1/X20CP0482/LibIP001/Valve_Biffist.h"
#line 1 "C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/LibIP001/Valve_Biffi.nodebug"
#line 3 "C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/LibIP001/Valve_Biffi.st"
...
case 0:{(__inst__->MBMCmd_0.enable=1);;(__inst__->MBMCmd_0.ident=__inst__->MBMOpen_0.ident);;(__inst__->MBMCmd_0.mfc=3);;(__inst__->MBMCmd_0.node=1);;(__inst__->MBMCmd_0.data=((unsigned long)(&__inst__->MB.Status)));;(__inst__->MBMCmd_0.offset=3002);;(__inst__->MBMCmd_0.len=1);;MBMCmd(&__inst__->MBMCmd_0);
if((((unsigned long)(unsigned short)__inst__->MBMCmd_0.status==(unsigned long)(unsigned short)0))){
(__inst__->step=1);
}
}break;case 1:{(__inst__->MBMCmd_0.enable=1);;(__inst__->MBMCmd_0.ident=__inst__->MBMOpen_0.ident);;(__inst__->MBMCmd_0.mfc=3);;(__inst__->MBMCmd_0.node=1);;(__inst__->MBMCmd_0.data=((unsigned long)(&__inst__->MB.Cur_Position)));;(__inst__->MBMCmd_0.offset=3005);;(__inst__->MBMCmd_0.len=1);;MBMCmd(&__inst__->MBMCmd_0);
if((((unsigned long)(unsigned short)__inst__->MBMCmd_0.status==(unsigned long)(unsigned short)0))){
(__inst__->step=2);
}
}break;case 2:{if((((unsigned long)(unsigned short)__inst__->MB.Commands!=(unsigned long)(unsigned short)__inst__->r0))){
(__inst__->MBMCmd_0.enable=1);;(__inst__->MBMCmd_0.ident=__inst__->MBMOpen_0.ident);;(__inst__->MBMCmd_0.mfc=6);;(__inst__->MBMCmd_0.node=1);;(__inst__->MBMCmd_0.data=((unsigned long)(&__inst__->r0)));;(__inst__->MBMCmd_0.offset=3007);;(__inst__->MBMCmd_0.len=1);;MBMCmd(&__inst__->MBMCmd_0);
if((((unsigned long)(unsigned short)__inst__->MBMCmd_0.status==(unsigned long)(unsigned short)0))){
...
(__inst__->MBMCmd_0.enable=1);;(__inst__->MBMCmd_0.ident=__inst__->MBMOpen_0.ident);;(__inst__->MBMCmd_0.mfc=6);;(__inst__->MBMCmd_0.node=1);;(__inst__->MBMCmd_0.data=((unsigned long)(&__inst__->Set_Position)));;(__inst__->MBMCmd_0.offset=3008);;(__inst__->MBMCmd_0.len=1);;MBMCmd(&__inst__->MBMCmd_0);
if((((unsigned long)(unsigned short)__inst__->MBMCmd_0.status==(unsigned long)(unsigned short)0))){
...
#line 76 "C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/LibIP001/Valve_Biffi.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/User/Desktop/IP001/IP001/Temp/Objects/DCS13_1/X20CP0482/LibIP001/Valve_Biffi.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/User/Desktop/IP001/IP001/Temp/Objects/DCS13_1/X20CP0482/LibIP001/Valve_Biffi.st.c\\\" \\\"C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/LibIP001/Valve_Biffi.st\\\"\\n\"");
