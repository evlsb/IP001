...
#include "C:/Users/User/Desktop/IP001/IP001/Temp/Objects/DCS13_1/X20CP0482/Lib489/FPostGassingst.h"
#line 1 "C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/Lib489/FPostGassing.nodebug"
#line 3 "C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/Lib489/FPostGassing.st"
void FPostGassing(struct FPostGassing* inst){struct FPostGassing* __inst__=inst;{

if((__inst__->HS01&(__inst__->HS01_Old^1))){
(__inst__->HL01=1);
(__inst__->HL02=1);
(__inst__->Sound=1);
}
if(((__inst__->HS01^1)&__inst__->HS01_Old)){
(__inst__->HL01=0);
(__inst__->HL02=0);
(__inst__->Sound=0);
}
(__inst__->HS01_Old=__inst__->HS01);

(__inst__->Level1=((_2byte_bit_field_*)(&__inst__->StatusAI))->bit1);
(__inst__->Level2=((_2byte_bit_field_*)(&__inst__->StatusAI))->bit2);

if((__inst__->Level1&(__inst__->Level1Old^1))){
(__inst__->HL01=1);
(__inst__->Sound=1);
}
if(((__inst__->Level1^1)&__inst__->Level1Old)){
(__inst__->HL01=0);
(__inst__->Sound=0);
}
if((__inst__->Level2&(__inst__->Level2Old^1))){
(__inst__->HL02=1);
(__inst__->Sound=1);
}
if(((__inst__->Level2^1)&__inst__->Level2Old)){
(__inst__->HL02=0);
(__inst__->Sound=0);
}
...
(__inst__->Level1Old=__inst__->Level1);
(__inst__->Level2Old=__inst__->Level2);
(__inst__->HA01=__inst__->Sound);
(__inst__->T.IN=__inst__->Level1);;(__inst__->T.PT=600000);;TON(&__inst__->T);
(__inst__->Level1_10min=__inst__->T.Q);
}}
#line 48 "C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/Lib489/FPostGassing.nodebug"

void __AS__ImplInitFPostGassing_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/User/Desktop/IP001/IP001/Temp/Objects/DCS13_1/X20CP0482/Lib489/FPostGassing.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/User/Desktop/IP001/IP001/Temp/Objects/DCS13_1/X20CP0482/Lib489/FPostGassing.st.c\\\" \\\"C:/Users/User/Desktop/IP001/IP001/Logical/Libraries/Lib489/FPostGassing.st\\\"\\n\"");
